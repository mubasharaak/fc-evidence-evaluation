...
parser.add_argument(
    '--test_data_path',
    default="/scratch/users/k20116188/fc_evidence_evaluation/datasets/hover/hover_test.jsonl",
...
parser.add_argument(
    '--dataset',
    default="hover",  # set to vitaminc if jsonl file with claim, evidence, label entries in dicts.
