...
parser.add_argument(
    '--test_data_path',
    default="/scratch/users/k20116188/fc_evidence_evaluation/datasets/vitaminc/vitaminc_test.jsonl",
...
parser.add_argument(
    '--hf_model',
    default="/scratch/users/k20116188/fc_evidence_evaluation/results/pseudo_trained_scorer/checkpoint-7500",
